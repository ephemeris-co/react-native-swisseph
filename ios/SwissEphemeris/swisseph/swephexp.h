...
#define ext_def(x) extern EXP32 x
  ...
  /****************************
   * exports from sweutils.c
   ****************************/

  ext_def(double) find_next_crossing(int ipl, double target_longitude, double start_jd);
  ext_def(double) find_previous_crossing(int ipl, double target_longitude, double start_jd);
